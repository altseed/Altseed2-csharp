...
namespace Altseed
{
    ...
    public struct Vector4F : IEquatable<Vector4F>
    {
        ...
        public static Vector4F Add(Vector4F v1, Vector4F v2) => v1 + v2;
        ...
        public static Vector4F Subtract(Vector4F left, Vector4F right) => left - right;
        ...
        public static Vector4F Multiple(Vector4F v1, Vector4F v2) => v1 * v2;
        ...
        /// <returns>除算結果(left.X / right.X, left.Y / right.Y, left.Z / right.Z, left.W / right.Z)</returns>
        public static Vector4F Divide(Vector4F left, Vector4F right) => left / right;
        ...
        /// <returns>除算結果(vector.X / scalar, vector.Y / scalar, vector.Z / scalar, vector.W / scalar, vector.W / scalar)</returns>
        public static Vector4F DivideByScalar(Vector4F vector, float scalar) => vector / scalar;
