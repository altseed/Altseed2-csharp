...
namespace Altseed2
{
    ...
    /// <summary>
    /// インデックスバッファを表す構造体
    /// 何番目の頂点を組み合わせて三角形を作り出すかどうかを表す
    /// </summary>
    [Serializable]
    [StructLayout(LayoutKind.Sequential)]
    public struct IndexBuffer : IEquatable<IndexBuffer>
    {
        /// <summary>
        /// 頂点インデックス1
        /// </summary>
        ...
        /// このインスタンスから要素を取り出します。
        /// </summary>
        /// <param name="index1"><see cref="Index1"/></param>
        /// <param name="index2"><see cref="Index2"/></param>
        /// <param name="index3"><see cref="Index3"/></param>
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// もう一つの<see cref="IndexBuffer"/>との間の等価性を判定します。
        /// </summary>
        /// <param name="other">等価性を判定する<see cref="IndexBuffer"/>のインスタンス</param>
        /// <returns><paramref name="other"/>との間との等価性が認められたらtrue，それ以外でfalse</returns>
        public readonly bool Equals(IndexBuffer other) => Index1 == other.Index1 && Index2 == other.Index2 && Index3 == other.Index3;
        ...
        /// <param name="obj">等価性を判定するオブジェクト</param>
        /// <returns><paramref name="obj"/>との間との等価性が認められたらtrue，それ以外でfalse</returns>
        public readonly override bool Equals(object obj) => obj is IndexBuffer p && Equals(p);

        /// <summary>
        /// このインスタンスのハッシュコードを返します。
        /// </summary>
        /// <returns>このインスタンスのハッシュコード</returns>
        public readonly override int GetHashCode() => HashCode.Combine(Index1, Index2, Index3);

        /// <summary>
        /// このインスタンスを表す文字列を取得します。
        /// </summary>
        /// <returns>このインスタンスを表す文字列</returns>
        public readonly override string ToString() => $"({Index1}, {Index2}, {Index3})";

        /// <summary>
        /// 二つの<see cref="IndexBuffer"/>の間の等価性を判定します。
        /// </summary>
        /// <param name="left">等価性を判定する<see cref="IndexBuffer"/>のインスタンス</param>
        /// <param name="right">等価性を判定する<see cref="IndexBuffer"/>のインスタンス</param>
        /// <returns><paramref name="left"/> と <paramref name="right"/> の間との等価性が認められたらtrue，それ以外でfalse</returns>
        public static bool operator ==(IndexBuffer left, IndexBuffer right) => left.Equals(right);
        /// <summary>
        /// 二つの<see cref="IndexBuffer"/>の間の非等価性を判定します。
        /// </summary>
        /// <param name="left">非等価性を判定する<see cref="IndexBuffer"/>のインスタンス</param>
        /// <param name="right">非等価性を判定する<see cref="IndexBuffer"/>のインスタンス</param>
        /// <returns><paramref name="left"/> と <paramref name="right"/> の間との非等価性が認められたらtrue，それ以外でfalse</returns>
        public static bool operator !=(IndexBuffer left, IndexBuffer right) => !(left == right);
    }
}
